    ...
    return (
        <div className='container w-1/3 mx-auto'>
            ...
            <div className='flex flex-col justify-between overflow-hidden border rounded-2xl'>
                ...
                <div className="flex">
                    <button
                        className='w-full py-2 bg-red-500 text-slate-100 hover:bg-red-800'
                        onClick={retornar}
                    >
                        Não
                    </button>
                    <button
                        className='flex items-center justify-center w-full bg-teal-600 text-slate-100 hover:bg-slate-800'
